package compsci.travelers.tests.business;
...
import compsci.travelers.business.SortTicketPricesLowToHigh;
import compsci.travelers.objects.Flight;

public class SortTicketPriceLowToHighTest extends TestCase {
    ArrayList<Flight> flightList;

    public SortTicketPriceLowToHighTest(String arg0) {
        super(arg0);
    }
    ...
    public void testSortWithNullList() {
        try {
            Collections.sort(null, new SortTicketPricesLowToHigh());
    ...
    public void testSortWithNullInstance() {
        ...
        flightList.add(f1);
        Collections.sort(flightList, new SortTicketPricesLowToHigh());
    ...
    public void testSortWithListOfValidAndInvalidItems() {
        ...
        flightList.add(f3);
        Collections.sort(flightList, new SortTicketPricesLowToHigh());
        assertEquals("Start Data: 02/22/2017, End Date: 02/22/2017, Start Time: 1:00, End Time: 3:30, Company: Air Canada, Price: 400, Flight ID: AC 345, Depart City: Calgary, Arrive City: Winnipeg, Duration: 2.5hrs", flightList.get(2).toString());
        assertEquals("Start Data: , End Date: , Start Time: , End Time: , Company: , Price: 0, Flight ID: , Depart City: , Arrive City: , Duration: ", flightList.get(0).toString());
        assertEquals("Start Data: , End Date: , Start Time: , End Time: , Company: , Price: 0, Flight ID: , Depart City: , Arrive City: , Duration: ", flightList.get(1).toString());
    }
